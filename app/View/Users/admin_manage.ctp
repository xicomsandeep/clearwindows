...
<div class="floatright"><?php echo $this->Html->link('<span>Add employee</span>', array('controller' => 'Users', 'action' => 'add'), array('class' => 'black_btn', 'escape' => false)) ?></div>
<div class="row mtop15">
	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
		<tr valign="top">
		  <td align="left" class="searchbox">
			<div class="floatleft">
				<?php echo $this->Form->create(null, array('url' => array('controller' => 'Users', 'action' => 'admin_index', 'admin' => true), 'name' => 'frm_srch', 'id' => 'frm_srch', 'type' => 'get', 'inputDefaults' => array('label' => false, 'div' => false, 'error' => false))) ?>
				  <table width="100%" cellpadding="4" cellspacing="2" >
					  <tr>
						  <td width="20%">Keyword</td>
						  <td width="30%"><?php echo $this->Form->input('keyword', array('name' => 'desc', 'class' => 'input', 'style' => "width: 300px;", 'value' => (!empty($this->params->query['title'])?$this->params->query['title']:''), 'required' => false)); ?></td>
					    </tr>
					    <tr>
...
<div class="row mtop30">
	<form name="frm_user" id="frm_user" action="<?php echo $this->Html->url(array('controller' => 'Users', 'action' => 'manage_action')); ?>" method="post" onsubmit="return CheckUserAction(this)">
		<br clear="all" /><table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
			...
			<tr>
				...
				<th width="17%" align="left" nowrap="nowrap">Full name</th>
	            <th width="12%" align="center" nowrap="nowrap">User type</th>
	            <th width="12%" align="center" nowrap="nowrap">Email</th>
	            <th width="12%" align="center" nowrap="nowrap">Satus</th>
			...
			if(count($users))
			{
				...
				<tr class="<?=$bgClass?>">
					...
					<td align="center"><?php echo $row_arr['Group']['name']; ?></td>
					...
					<td align="center">
						<?php echo $this->Html->image(ADMIN_IMAGES_PATH.'edit_icon.gif', array('url'=>array('controller'=>'users', 'action'=>'edit', $row['id'], 'admin'=>true))); ?>
				
						<?php echo $this->Html->image(ADMIN_IMAGES_PATH.'view.gif', array('url'=>array('controller'=>'Users', 'action'=>'view', $row['id'], 'admin'=>true))); ?>
